...
const example: Record<string, unknown> = {
  ...
  'plant.update': { type: 'plant.update', placeId: 'PLACE_ID' },
  'plant.create': { type: 'plant.create', speciesSlug: 'ficus-lyrata', placeId: 'PLACE_ID', acquiredOn: '2026-07-20', nickname: 'Figaro' },
  'progress.create': { type: 'progress.create', health: 'GOOD', occurredOn: '2026-07-20', observations: 'Moved to the east window.' },
  'progress.update': { type: 'progress.update', entryId: 'ENTRY_ID', health: 'EXCELLENT' },
  'frequency.set': { type: 'frequency.set', task: 'WATER', intervalDays: 9 },
